...
# Description:  This is the solution for course Assignment 1 (plot 4) for
...
run_analyse <- function(){
  ...
  plot(
    sub_data$DateTime, sub_data$Global_active_power, xaxt=NULL, 
  ...
  #Add the plot for the top right hand of the screen
  plot(
    sub_data$DateTime, sub_data$Voltage, xaxt=NULL, 
      xlab = "Date-Time", ylab = "Voltage", type="n")
  #Add data lines to the plot
  lines(sub_data$DateTime, sub_data$Voltage, type="S")
  ...
  #Add the final plot to the bottom right hand of the screen
  plot(
    sub_data$DateTime, sub_data$Global_reactive_power, xaxt=NULL, 
      xlab="Date-Time", ylab = "Global Reactive Power", type="n")
  #Add the data lines
  lines(sub_data$DateTime, sub_data$Global_reactive_power, col = "blue", type="S")
